...
| Candidate 1 runtime soak | [machine-readable report](../../evidence/candidate1-runtime-soak.json); [human-readable report](../../evidence/candidate1-runtime-soak.md) | One controlled 500-attempt real Candidate runtime-soak result. It records technical reliability, reconnect and malformed-input recovery, and separate client/server latency observations. `PASS` is not a performance threshold, lifecycle action, or production authorization. |
